...
class DiaryRepositoryImpl @Inject constructor(
    ...
    override suspend fun getDailyClassTypes(): Result<List<DiaryDailyClassType>> = try {
    ...
    ): Result<DiaryQuestionnaireData> = try {
    ...
    override suspend fun getMyDiarySubmissions(): Result<List<com.wafflestudio.snutt2.domain.model.diary.CourseBookDiarySubmissions>> = try {
