...
class ThemeRepositoryImpl @Inject constructor(
    ...
    override fun getTheme(themeId: String): CustomTheme = _customThemes.value.find { it.id == themeId } ?: CustomTheme.Default

    override suspend fun fetchThemes(): Result<Unit> = try {
    ...
    override suspend fun createTheme(name: String, colors: List<ThemeColor>): Result<CustomTheme> = try {
        val newTheme =
    ...
    override suspend fun copyTheme(themeId: String): Result<Unit> = try {
    ...
    override suspend fun deleteTheme(themeId: String): Result<Unit> = try {
