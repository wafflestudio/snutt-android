...
import com.wafflestudio.snutt2.core.data.toNotificationTempModel
import com.wafflestudio.snutt2.core.data.toTempModel
import com.wafflestudio.snutt2.core.network.SNUTTNetworkDataSource
import com.wafflestudio.snutt2.data.toExternalModel
import com.wafflestudio.snutt2.data.toNotificationExternalModel
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, NotificationDto> {
        ...
        return try {
            val response = api._getNotification(
                ...
                offset = offset,
                explicit = 1,
            ).toNotificationTempModel().toNotificationExternalModel() // TODO : 변환 함수 사용 부분
            LoadResult.Page(
                data = response,
