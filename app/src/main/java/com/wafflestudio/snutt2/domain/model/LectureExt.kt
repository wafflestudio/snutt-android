...
fun List<Lecture>.getFittingTrimParam(tableTrimParam: TableTrimParam): TableTrimParam = TableTrimParam(
...
fun getCreditSumFromLectureList(lectureList: List<Lecture>): Long = lectureList.fold(0L) { acc, lecture -> acc + lecture.credit }
