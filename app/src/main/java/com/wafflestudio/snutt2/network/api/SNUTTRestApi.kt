package com.wafflestudio.snutt2.network.api

import com.wafflestudio.snutt2.network.dto.BuildingsResponse
import com.wafflestudio.snutt2.network.dto.DeleteFirebaseTokenResults
import com.wafflestudio.snutt2.network.dto.DeleteLectureResults
...
import com.wafflestudio.snutt2.network.dto.GetDailyClassTypesResults
import com.wafflestudio.snutt2.network.dto.GetFriendCourseBooksResults
import com.wafflestudio.snutt2.network.dto.GetFriendPrimaryTableResults
import com.wafflestudio.snutt2.network.dto.GetFriendRequestLinkResults
import com.wafflestudio.snutt2.network.dto.GetFriendsResults
import com.wafflestudio.snutt2.network.dto.GetLectureReviewSummaryResult
import com.wafflestudio.snutt2.network.dto.GetMyDiarySubmissionsResults
import com.wafflestudio.snutt2.network.dto.GetNotificationCountResults
import com.wafflestudio.snutt2.network.dto.GetNotificationResults
import com.wafflestudio.snutt2.network.dto.GetPopupResults
import com.wafflestudio.snutt2.network.dto.GetRecentTableResults
import com.wafflestudio.snutt2.network.dto.GetRemoteConfigResponse
import com.wafflestudio.snutt2.network.dto.GetSemesterStatusResult
import com.wafflestudio.snutt2.network.dto.GetSocialProvidersResults
import com.wafflestudio.snutt2.network.dto.GetTableByIdResults
import com.wafflestudio.snutt2.network.dto.GetTableListResults
import com.wafflestudio.snutt2.network.dto.GetTagListResults
import com.wafflestudio.snutt2.network.dto.GetThemesResults
import com.wafflestudio.snutt2.network.dto.GetTimetableRemindersResults
import com.wafflestudio.snutt2.network.dto.GetUserInfoResults
import com.wafflestudio.snutt2.network.dto.GetVacancyLecturesResults
import com.wafflestudio.snutt2.network.dto.OkResponseDto
...
import com.wafflestudio.snutt2.network.dto.PatchThemeResults
import com.wafflestudio.snutt2.network.dto.PatchUserInfoParams
import com.wafflestudio.snutt2.network.dto.PatchUserInfoResults
import com.wafflestudio.snutt2.network.dto.PostAcceptFriendByLinkResults
...
import com.wafflestudio.snutt2.network.dto.PostCheckEmailByIdResults
import com.wafflestudio.snutt2.network.dto.PostCopyTableResults
import com.wafflestudio.snutt2.network.dto.PostCopyThemeResults
import com.wafflestudio.snutt2.network.dto.PostCustomLectureParams
import com.wafflestudio.snutt2.network.dto.PostCustomLectureResults
import com.wafflestudio.snutt2.network.dto.PostFeedbackParams
import com.wafflestudio.snutt2.network.dto.PostFeedbackResults
import com.wafflestudio.snutt2.network.dto.PostFindIdParams
import com.wafflestudio.snutt2.network.dto.PostFindIdResults
import com.wafflestudio.snutt2.network.dto.PostForceLogoutParams
import com.wafflestudio.snutt2.network.dto.PostForceLogoutResults
...
import com.wafflestudio.snutt2.network.dto.PostSearchQueryResults
...
import com.wafflestudio.snutt2.network.dto.PostSignInResults
import com.wafflestudio.snutt2.network.dto.PostSignUpParams
import com.wafflestudio.snutt2.network.dto.PostSignUpResults
import com.wafflestudio.snutt2.network.dto.PostSocialLinkResults
import com.wafflestudio.snutt2.network.dto.PostSocialLoginParams
import com.wafflestudio.snutt2.network.dto.PostSocialLoginResults
import com.wafflestudio.snutt2.network.dto.PostTableParams
import com.wafflestudio.snutt2.network.dto.PostTableResults
import com.wafflestudio.snutt2.network.dto.PostThemeParams
import com.wafflestudio.snutt2.network.dto.PostThemeResults
import com.wafflestudio.snutt2.network.dto.PostUserPasswordParams
import com.wafflestudio.snutt2.network.dto.PostUserPasswordResults
...
import com.wafflestudio.snutt2.network.dto.PutLectureResults
import com.wafflestudio.snutt2.network.dto.PutTableParams
import com.wafflestudio.snutt2.network.dto.PutTableResults
import com.wafflestudio.snutt2.network.dto.PutTableThemeParams
import com.wafflestudio.snutt2.network.dto.PutTableThemeResult
...
import com.wafflestudio.snutt2.network.dto.PutUserPasswordResults
