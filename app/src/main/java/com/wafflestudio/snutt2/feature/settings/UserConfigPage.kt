...
fun UserConfigRoute(
    ...
    UserConfigScreen(
        ...
        onChangePasswordCurrentChange = viewModel::onChangePasswordCurrentChange,
        onChangePasswordNewChange = viewModel::onChangePasswordNewChange,
        onChangePasswordNewConfirmChange = viewModel::onChangePasswordNewConfirmChange,
        ...
        onAddIdPasswordIdChange = viewModel::onAddIdPasswordIdChange,
        onAddIdPasswordPasswordChange = viewModel::onAddIdPasswordPasswordChange,
        onAddIdPasswordPasswordConfirmChange = viewModel::onAddIdPasswordPasswordConfirmChange,
...
fun UserConfigScreen(
    ...
    UserConfigDialogs(
        ...
        onChangePasswordCurrentChange = onChangePasswordCurrentChange,
        onChangePasswordNewChange = onChangePasswordNewChange,
        onChangePasswordNewConfirmChange = onChangePasswordNewConfirmChange,
        onConfirmChangePassword = onConfirmChangePassword,
        onDismissChangePassword = onDismissChangePassword,
        onAddIdPasswordIdChange = onAddIdPasswordIdChange,
        onAddIdPasswordPasswordChange = onAddIdPasswordPasswordChange,
        onAddIdPasswordPasswordConfirmChange = onAddIdPasswordPasswordConfirmChange,
