...
import com.wafflestudio.snutt2.core.network.model.PostCustomLectureParams as PostCustomLectureParamsNetwork
...
fun PostCustomLectureParams.toNetworkModel() = PostCustomLectureParamsNetwork(
    id = this.id,
