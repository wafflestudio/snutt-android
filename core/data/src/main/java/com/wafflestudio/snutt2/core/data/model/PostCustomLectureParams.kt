...
data class PostCustomLectureParamsT(
    ...
    @Json(name = "class_time_json") var class_time_json: List<com.wafflestudio.snutt2.core.data.model.ClassTimeDtoT>? = null,
    ...
    @Json(name = "color") var color: com.wafflestudio.snutt2.core.data.model.ColorDtoT? = null,
