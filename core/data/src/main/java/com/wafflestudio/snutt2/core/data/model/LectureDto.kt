...
data class LectureDtoT(
    ...
    @Json(name = "class_time_json") val class_time_json: List<com.wafflestudio.snutt2.core.data.model.ClassTimeDtoT>,
    ...
    @Json(name = "color") val color: com.wafflestudio.snutt2.core.data.model.ColorDtoT = com.wafflestudio.snutt2.core.data.model.ColorDtoT(),
